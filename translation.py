class Translation(object):
    START_TEXT = """Hello user, am at your service, how can i help you."""
    RENAME_403_ERR = "Am so Sorry. You are not allowed to rename this file."
...
URL | filename | username | password"""
    ...
    DOWNLOAD_START = "Let.. me try to download it!"
    UPLOAD_START = "wait..uploading file"
    RCHD_BOT_API_LIMIT = "size greater than maximum allowed size (50MB). Neverthless, trying to upload."
    RCHD_TG_API_LIMIT = "Downloaded in {} seconds.\nDetected File Size: {}\nSorry. But, I cannot upload files greater than 1.5GB due to Telegram API limitations."
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Kindly rate our gallery if you find me useful. https://t.me/movieseriesGallery"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Kindly rate our gallery if you find me useful. https://t.me/movieseriesGallery \nUploaded in {} seconds.""
    NOT_AUTH_USER_TEXT = "Please /upgrade your subscription."
    NOT_AUTH_USER_TEXT_FILE_SIZE = "Detected File Size: {}. Free Users can only upload: {}\nPlease /upgrade your subscription.\nIf you think this is a bug, please contact <a href='https://telegram.dog/ThankTelegram'>@SpEcHlDe</a>"
    SAVED_CUSTOM_THUMB_NAIL = "Custom video / file thumbnail saved. This image will be used in the video / file."
    DEL_ETED_CUSTOM_THUMB_NAIL = "✅ Custom thumbnail cleared succesfully."
    FF_MPEG_DEL_ETED_CUSTOM_MEDIA = "✅ Media cleared succesfully."
    SAVED_RECVD_DOC_FILE = "Your file is Downloaded Successfully." 
